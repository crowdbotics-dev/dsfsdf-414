"""
Django settings for dsfsdf_414 project.
...
WSGI_APPLICATION = 'dsfsdf_414.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dsfsdf_414 API",
    "DESCRIPTION": "API documentation for dsfsdf_414 App",
    "VERSION": "v1",
}
